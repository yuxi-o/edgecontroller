...
var _ = Describe("Entities: DNSContainerAppAlias", func() {
	var (
		alias *cce.DNSContainerAppAlias
	)
	...
	Describe("GetTableName", func() {
		It(`Should return "dns_container_app_aliases"`, func() {
			Expect(alias.GetTableName()).To(Equal("dns_container_app_aliases"))
		})
	})
