...
VALUES
    (
        '{
            "id": "9112538c-4df3-4a7a-a7e6-5db9ec203d03",
            "name": "Test Node 1",
            "location": "Local 8081",
            "serial": "ABC-123",
            "grpc_target": "127.0.0.1:8081"
        }'
    ),
    (
        '{
            "id": "e5f52ed1-7771-4fd4-8c73-df5d0af3d87d",
            "name": "Test Node 2",
            "location": "Local 8082",
            "serial": "ABC-456",
    ...
    (
        '{
            "id": "86003d1d-91e3-48d8-a1ed-125514bc69f1",
            "name": "Test Node 3",
            "location": "Local 8083",
            "serial": "ABC-789",
            "grpc_target": "127.0.0.1:8083"
        }'
    )
;
