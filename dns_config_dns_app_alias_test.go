...
var _ = Describe("Entities: DNSConfigDNSAppAlias", func() {
	var (
		cfgAlias *cce.DNSConfigDNSAppAlias
	)
	...
	BeforeEach(func() {
		cfgAlias = &cce.DNSConfigDNSAppAlias{
			...
			DNSAppAliasID: "a48145cc-87de-4aa9-814d-51d23a47eccd",
		}
	})

	Describe("GetTableName", func() {
		It(`Should return "dns_configs_dns_app_aliases"`, func() {
	...
	Describe("Validate", func() {
		...
		It("Should return an error if DNSAppAliasID is not a UUID", func() {
			cfgAlias.DNSAppAliasID = "123"
			Expect(cfgAlias.Validate()).To(MatchError(
				"dns_app_alias_id not a valid uuid"))
		})
	})
