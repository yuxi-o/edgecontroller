...
var _ = Describe("Entities: VMVNF", func() {
	var (
		vnf *cce.VMVNF
	)
	...
	BeforeEach(func() {
		vnf = &cce.VMVNF{
			ID:          "8555211d-f572-45e4-bf54-4606481c84eb",
			Name:        "test-vm-vnf",
			Vendor:      "test-vendor",
	...
	Describe("GetTableName", func() {
		It(`Should return "vm_vnfs"`, func() {
			Expect(vnf.GetTableName()).To(Equal("vm_vnfs"))
		})
	})
	...
	Describe("GetID", func() {
		It("Should return the ID", func() {
			Expect(vnf.GetID()).To(Equal(
				"8555211d-f572-45e4-bf54-4606481c84eb"))
		})
	})
