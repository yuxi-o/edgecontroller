...
var _ = Describe("Entities: DNSConfigDNSVMVNFAlias", func() {
	var (
		cfgAlias *cce.DNSConfigDNSVMVNFAlias
	)
	...
	BeforeEach(func() {
		cfgAlias = &cce.DNSConfigDNSVMVNFAlias{
			...
			DNSVMVNFAliasID: "5fc828ec-3412-4265-bfd0-e4bc3cc51d8c",
		}
	})

	Describe("GetTableName", func() {
		It(`Should return "dns_configs_dns_vm_vnf_aliases"`, func() {
	...
	Describe("Validate", func() {
		...
		It("Should return an error if DNSVMAppAliasID is not a UUID", func() {
			cfgAlias.DNSVMVNFAliasID = "123"
			Expect(cfgAlias.Validate()).To(MatchError(
				"dns_vm_vnf_alias_id not a valid uuid"))
		})
	})
